...
namespace Portfolio.Migrations
{
    ...
    [Migration("20260318194255_Carousel photo configuration")]
    partial class Carouselphotoconfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Models.Models.PhotoPosition", b =>
                {
                    ...
                    b.Property<int>("PhotoPositionTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PhotoPositionTypeId");

                    b.ToTable("PhotoPosition");
                });

            modelBuilder.Entity("Portfolio.Models.Models.PhotoPositionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.Models.Models.PhotoPosition", b =>
                {
                    b.HasOne("Portfolio.Models.Models.Photo", "Photo")
                        .WithMany("PhotoPositions")
                        .HasForeignKey("PhotoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Portfolio.Models.Models.PhotoPositionType", "PhotoPositionType")
                        .WithMany("PhotoPositions")
                        .HasForeignKey("PhotoPositionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Photo");

                    b.Navigation("PhotoPositionType");
                });
